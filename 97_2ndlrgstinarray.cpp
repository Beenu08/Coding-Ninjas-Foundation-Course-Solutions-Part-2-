...
If N <= 1 or all the elements are same in the array/list then return -2147483648 
or -2 ^ 31(It is the smallest value for the range of Integer)
Input format :
...
in the array/list.
Output Format :
For each test case, print the second largest in the array/list if exists, -2147483648 
otherwise.
...
void second(int A[],int n){
    ...
    cout<<secmax<<"is second maximum"<<endl;
}
int main(){
    int n;
    cin>>n;
